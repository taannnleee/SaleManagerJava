public class SanPhamTrongKho {
    ...
    private static DanhSachSanPham Init()
    {
        ...
        list_.AddLast(new SanPham("SP01", "Ti Vi", 100, new ThoiGian(1, 1, 2012, 20, 20, 30), new ThoiGian(9, 9, 2020, 15, 30, 0), 25000000));
        list_.AddLast(new SanPham("SP02", "May In", 120, new ThoiGian(2, 2, 2012, 20, 20, 30), new ThoiGian(8, 8, 2051, 11, 45, 30), 27000000));
